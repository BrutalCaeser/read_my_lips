...
from float_module.models.float.FLOAT import FLOAT
from float_module.options.base_options import BaseOptions
...
class DataProcessor:
	def __init__(self, opt):
		...
		device = str(opt.rank) if hasattr(opt, 'rank') else 'cpu'
